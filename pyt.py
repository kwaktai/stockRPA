...
userInfo = {"곽일태": {"SOXL": 5, "DFEN": 2, "TPOR": 2, "FNGU": 9,
                    "WEBL": 6, "NAIL": 3, "QLD": 4, "TQAQQ": 4, "TQQQ": 4, "BNKD": 20}, "이가은": {"SOXL": 5, "DFEN": 2, "TPOR": 2, "FNGU": 5,
                                                                                                "WEBL": 6, "NAIL": 2, "QLD": 4, "TQAQQ": 2, "TQQQ": 2, "BNKD": 20}}

# print(userInfo["이가은"]["SOXL"])
...
def getQty(stock_name="SOXL", user="곽일태"):
    # my_shares_list = {"SOXL": 5, "DFEN": 2, "TPOR": 2, "FNGU": 9,
    #                   "WEBL": 6, "NAIL": 3, "QLD": 4, "TQAQQ": 4, "TQQQ": 4, "BNKD": 20}
    my_shares_list = userInfo[user]
    stock_qty = my_shares_list[stock_name]
    my_shares_list_stock_name = list(my_shares_list.keys())
    return stock_qty, my_shares_list_stock_name
